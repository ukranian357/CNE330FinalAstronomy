...
def createSSandAnimate():
   ...
   m = Planet("MERCURY", 19.5, 1000, .25, -20, 3.0, "blue")
   ss.addPlanet(m)

   m = Planet("EARTH", 47.5, 5000, 0.3, -15, 2.0, "green")
   ss.addPlanet(m)

   m = Planet("MARS", 50, 9000, 0.5, -12, 1.63, "red")
   ss.addPlanet(m)

   m = Planet("JUPITER", 100, 49000, 0.7, -10, 1, "purple")
   ss.addPlanet(m)

   m = Planet("Pluto", 1, 500, 0.9, -8, .5, "orange")
   ss.addPlanet(m)

   m = Planet("Asteroid", 1, 500, 1.0, -8, .75, "cyan")
   ss.addPlanet(m)
...
createSSandAnimate()
# changed velocity of x on all planets to change orbit from ellipsis style to almost crashing into black hole and straying into a new orbit after being subjected to the black hole gravity
#also changed sun to black hole by changing color from yellow to black